                            ...
                            <div class="card card-bordered product-card">
                                ...
                                <div class="card-inner text-center">
                                    <ul class="product-tags">
                                        <li><a href="/admin/paket/1">Package</a></li>
                                    </ul>
                                    <h5 class="product-title"><a href="/admin/paket/1">Weight Loss
                                            Package</a></h5>
                                    <div class="product-price text-primary h5"> Rp. 800.000,-</div>
                                </div>
                            </div>
                        </div><!-- .col -->
                        <div class="col-xxl-3 col-lg-4 col-sm-6">
                            <div class="card card-bordered product-card">
                                ...
                                <div class="card-inner text-center">
                                    ...
                                    <h5 class="product-title"><a href="html/product-details.html">Weight Loss
                                            Package</a></h5>
                                    <div class="product-price text-primary h5"> Rp. 800.000,-</div>
                                </div>
                            </div>
