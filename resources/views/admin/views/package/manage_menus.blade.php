                                    ...
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col tb-col-sm">
                                            <span class="tb-product">
                                                <img src="{{ asset('assets/img/menu/menu-item-2.png') }}" alt=""
                                                    class="thumb">
                                                <span class="title">Nasi Goreng Biasa</span>
                                            </span>
                                        </div>
                                        <div class="nk-tb-col">
                                            <span class="tb-sub">Nasi Goreng Biasa dengan telur dan ayam goreng yang
                                                digoreng bersama nasi putih yang sudah dihaluskan dan diiris-iris
                                                kecil</span>
                                        </div>
                                        <div class="nk-tb-col">
